<h2><a href="https://leetcode.com/problems/process-tasks-using-servers">2012. Process Tasks Using Servers</a></h2><h3>Medium</h3><hr><p>You are given two <strong>0-indexed</strong> integer arrays <code>servers</code> and <code>tasks</code> of lengths <code>n</code>ââââââ and <code>m</code>ââââââ respectively. <code>servers[i]</code> is the <strong>weight</strong> of the <code>i<sup>ââââââth</sup></code>ââââ server, and <code>tasks[j]</code> is the <strong>time needed</strong> to process the <code>j<sup>ââââââth</sup></code>ââââ task <strong>in seconds</strong>.</p>
...
<p>Build an array <code>ans</code>ââââ of length <code>m</code>, where <code>ans[j]</code> is the <strong>index</strong> of the server the <code>j<sup>ââââââth</sup></code> task will be assigned to.</p>

<p>Return <em>the array </em><code>ans</code>ââââ.</p>
